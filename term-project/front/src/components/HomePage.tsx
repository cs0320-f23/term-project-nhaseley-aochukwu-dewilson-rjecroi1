  ...
  return (
    <div className="homepage">
      ...
      <p className="homepage-description">
        BISH Boston is a housing
        locator application made for students at Brown University
        seeking summer intern housing in the greater Boston area. Now, finding
        housing is as easy as a click of a button. Register below to see
